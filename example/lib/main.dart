...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = await _mediapipeFlutterPlugin.getPlatformVersion() ??
        ...
        body: Center(
          child: Column(
            children: [
              ...
              ElevatedButton(
                  onPressed: () {
                    var res = _mediapipeFlutterPlugin.initCamera();
                    res.then((value) => setState(() {
                          _callResult = value ?? 'Unknown call result';
                        }));
                  },
                  child: const Text("Init camera")),
              Text('Call result: $_callResult\n'),
